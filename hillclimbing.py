...
# Fungsi untuk menjalankan algoritma Hill Climbing untuk TSP
def tsp_hill_climbing(coordinates, num_iterations):
    ...
    for _ in range(num_iterations):
        ...
        best_neighborhood_distance = calculate_total_distance(current_path, coordinates)
        ...
        # Menghentikan iterasi jika tidak ada perbaikan yang lebih baik
        if best_neighborhood_path is None:
            break
...
# Jumlah iterasi untuk algoritma Hill Climbing
num_iterations = 1000

# Menjalankan algoritma Hill Climbing dan menampilkan hasilnya
best_path = tsp_hill_climbing(coordinates, num_iterations)
